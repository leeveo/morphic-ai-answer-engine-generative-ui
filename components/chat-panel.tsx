...
export function ChatPanel({ messages, query }: ChatPanelProps) {
  ...
  // Si des messages existent, afficher le bouton "Nouveau"
  ...
  return (
    <div
      className={
        'fixed bottom-8 left-0 right-0 top-10 mx-auto flex flex-col items-center justify-center h-full w-full max-w-[calc(100%-300px)] md:max-w-[calc(100%-450px)]'
      }
    >
      <form onSubmit={handleSubmit} className="w-full px-6 max-w-lg">
        <div className="relative flex items-center w-full">
          <Textarea
            ...
            maxRows={5}
            tabIndex={0}
            placeholder="Discutons de la Bretagne..."
            spellCheck={false}
            value={input}
