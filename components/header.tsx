...
export const Header: React.FC = async () => {
  return (
    <header
      ...
      style={{ backgroundImage: 'url(/images/high-angle-view-of-the-beach-of-saint-malo-2023-11-27-04-51-01-utc.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', height: '300px' }}
    >
